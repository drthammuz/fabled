...
pub const ALL_CLASSES: [ClassDef; 4] = [
    ClassDef {
        ...
        name: "Soldier",
        description: "+50% HP · Enemies prioritise you\nWears armor (others can't) · Faster melee\nHighest carry capacity · 5 slots\nStarts with Melee + Blaster",
        max_hp: 150.0,
        speed_mult: 1.0,
        inventory_slots: 5,
        starting_items: &[items::MELEE, items::SCRAP_PISTOL],
    ...
    ClassDef {
        ...
        name: "Medic",
        description: "Heals others (+50% item effect) · 5 slots\nLeft-click an ally to heal, use on self too\nRevive downed teammates (coming soon)\nStarts with Melee + Medical Bag",
        max_hp: 100.0,
        speed_mult: 1.0,
        inventory_slots: 5,
        starting_items: &[items::MELEE, items::MEDICAL_BAG],
