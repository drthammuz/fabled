...
# wall_X() fills that opening.  No template-floor-* on room shells — the room GLB
# already includes floor meshes; extra floor tiles z-fight (duplicate textures).
...
# 5) 4-open N+S+E+W  ─ main hub; no walls
...
m08 = module("m08_nsew_variation", [
    pc("room-large-variation", 0, 0),
    pc("gate", 0, -10, 0.0),  # on module wall plane (not cell centre at -8)
    pc("gate", 0,  10, 0.0),
])
